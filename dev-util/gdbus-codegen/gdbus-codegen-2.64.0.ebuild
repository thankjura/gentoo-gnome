...
python_prepare_all() {
	...
	MAJOR_VERSION=$(ver_cut 1-2)
	MINOR_VERSION=$(ver_cut 3-)
	sed -e "s:@VERSION@:${PV}:" -e "s:@MAJOR_VERSION@:${MAJOR_VERSION}:" -e "s:@MINOR_VERSION@:${MINOR_VERSION}:" config.py.in > config.py || die
