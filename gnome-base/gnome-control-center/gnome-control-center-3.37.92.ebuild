...
src_install() {
	meson_src_install
	rm -rf ${D}/usr/include/libhandy-1
	rm -rf ${D}/usr/lib64/libhandy-1.so.0
	rm -rf ${D}/usr/lib64/libhandy-1.so
	rm -rf ${D}/usr/lib64/pkgconfig/libhandy-1.pc
	rm -rf ${D}/usr/share/locale/*/LC_MESSAGES/libhandy.mo
}
